...
public class TransferProgressUpdater {
    ...
    public PublisherListener<S3MetaRequestProgress> publisher() {
        ...
        return new PublisherListener<S3MetaRequestProgress>(){
            ...
            @Override
            public void subscriberOnNext(S3MetaRequestProgress byteBuffer) {
                incrementBytesTransferred(Long.valueOf(byteBuffer.getBytesTransferred()).intValue(),
                                          byteBuffer.getContentLength());
            }
